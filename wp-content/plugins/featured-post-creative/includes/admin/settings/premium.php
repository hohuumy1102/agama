				...
				<table class="wpos-plugin-pricing-table">
					...
					<tbody>
						<tr>
							...
							<td>1 </td>
							<td>20 grid and grid box, 20 slider and carousel layout</td>
						</tr>

						<tr>
							<th>Shortcodes <span class="subtext">Shortcode provide output to the front-end side</span></th>
							<td>2 - (Post Grid, Post Grid block)</td>
							<td>8 - (Feature Post Grid, Feature Post Slider, Feature Post GridBox, Feature Post Carousel, Trending Post Grid, Trending Post Slider, Trending Post GridBox, Trending Post Carousel)</td>
						</tr>
						...
						<tr>
							<th>Trending Post Support<span>Display trending posts as well.</span></th>
